...
class SISSimulation:
    ...
    def start(self):
        ...
        print '---simulation finished in {} hours, {} mins , {} secs ---'.format(3600 % 24, round(end_time / 60 % 60),
                                                                                 round(end_time % 60, 2))
    ...
    def simulate_for_prob_infection_range(self, n_reps, prob_being_initially_infected, t_max, t_trans):
        ...
        self.filename = os.path.join(self.output_path, 'A4' + 'Airport')
    ...
    def plot(self, x, y):
        title = 'Airport'
        title += '\nSIS (' + r'$\mu = {},\rho$0 = {})'.format(self.prob_spontaneous_recovery,
                                                              self.prob_being_initially_infected)
...
if __name__ == '__main__':
    sis = SISSimulation(0.3, 51, 50, 0.2, 1000, 900, 'outputs/')
    sis.start()